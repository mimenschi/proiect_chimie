  ...
  return (
    <>
      ...
      <div className='reactii'>
        ...
        <h3 className='titlureactie'>1. Coroziunea cu depolarizare de hidrogen</h3>

        <strong>În medii acide:</strong>
        <div className='reactii-bula'>
        ...
        <h3 className='titlureactie'>2. Coroziunea cu depolarizare de oxigen</h3>
        <strong>În medii acide:</strong>
        <div className='reactii-bula'>
          <div className='textReactii'>
            <pre>Oxidare: Fe → Fe²⁺ + 2e⁻</pre>
