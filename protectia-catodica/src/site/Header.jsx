...
function Header() {
     return(
        <header>
            ...
            <p className="textTeorie fade-in-on-load"> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
